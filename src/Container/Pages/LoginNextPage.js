        ...
        <div>
            ...
            <div className="LoginNextBox">
                <p
                    ...
                    style={{ marginLeft: "75px", marginTop: " 32px" }}
                >
                    Hello,<span> mohit.gopal18@gmail.com</span>
                </p>
                <div className="addressConfirmBox">
                    <div className="addressChange">
                        <p className="addressDeliverConfirm">
                            Your delivery address
                        </p>
                        <div>
                            <label className="containerRadio">
                                Green Park, Safdarjung Enclave New Delhi -
                                110029, Maximum lines 3 to 4
                                <input
                                    type="radio"
                                    name="selection"
                                    value="one"
                    ...
                    <div className="phoneChange">
                        ...
                        <div style={{ display: "flex", marginTop: "12px" }}>
                            ...
                            ></span>
                            <p className="noEmailfinal">
                                mohit.gopal18@gmail.com
                            </p>
                        </div>
                        <p className="changeDetail">Change</p>
                    </div>
