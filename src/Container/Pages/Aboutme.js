...
function Aboutme() {
    ...
    let sorc =
        "https://ii1.pepperfry.com/media/catalog/product/g/o/1100x1210/golden-aluminium-radha-krishna-statue-religious-idol-by-handicrafts-paradise-golden-aluminium-radha--46ymxk.jpg";
    return (
        <div className="headerr">
            ...
            <div className="MyDescription">
                ...
                {/* <div>
                    <FaPhoneAlt
                        style={{ marginTop: "0.256vw", opacity: "0.8" }}
                    />
                    <p style={{ marginLeft: "1.249vw" }}>{cno}</p>
                </div> */}
                <div>
                    <GrMail style={{ marginTop: "0.35vw", opacity: "0.8" }} />
                    <p style={{ marginLeft: "1.249vw" }}>{email}</p>
                </div>
            </div>
            <button
                style={{
            ...
            {/* <div className="editProfile1">
                <div className="editSmallPop">
                    <div className="editHeading">
                        <div className="editClose" onClick={closeEdit}>
                            +
                        </div>
                        <p className="editPopHeading">Logout</p>
                    </div>
                    ...
                    <div className="saveExitButton">
                        <button id="cancelEditButton" onClick={closeEdit}>
                            CANCEL
                        </button>
